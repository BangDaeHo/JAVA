...
public class Nation {
    ...
    private final double populationl; private final int gdpRank;

    public Nation(String name, Type type, double populationl, int gdpRank){
        this.name = name; this.type = type;
        this.populationl = populationl; this.gdpRank = gdpRank;
    }

    public String getName() {return name;}
    public Type getType() {return type;}
    public boolean isIsland() {return getType() != Type.LAND;}
    public double getPopulation() {return populationl;}
